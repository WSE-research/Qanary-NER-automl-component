...
If a pre-trained model is intended to be provided, it must be available in the folder link:./AutomationService/AutomationServiceBackend-wittigannemarie/data/model[AutomationService/AutomationServiceBackend-wittigannemarie/data/model] (default configuration).
...
Both files must be provided in the folder link:./AutomationService/AutomationServiceBackend-wittigannemarie/data/trainingdata[AutomationService/AutomationServiceBackend-wittigannemarie/data/trainingdata].
...
* In the link:./AutomationService/AutomationServiceBackend-wittigannemarie/app/.env[.env] file of the component, the following values have to be adjusted:
** `MLFLOW_URI`
